                ...
                <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                  <div className="flex w-2/5">
                    ...
                    <div className="flex flex-col justify-between ml-4 flex-grow">
                      ...
                      <span className="text-red-500 text-xs capitalize">{cart?.category?.name}</span>
                  ...
                  <span className="text-center w-1/5 font-semibold text-sm">{formatPriceVND(cart?.price)}</span>
                  <span className="text-center w-1/5 font-semibold text-sm">{formatPriceVND(cart?.price * cart?.quantity)}</span>
                </div>
              )
            })
          }
